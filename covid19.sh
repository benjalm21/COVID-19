...
curl -O http://datosabiertos.salud.gob.mx/gobmx/salud/datos_abiertos/diccionario_datos_covid19.zip

unzip diccionario_datos_covid19.zip.zip && \
rm rm datos_abiertos_covid19.zip && \ && \

unzip datos_abiertos_covid19.zip && \
rm datos_abiertos_covid19.zip && \

mv *COVID19MEXICO.csv virgindata.csv
mv *Catalogos.xlsx Catalogos.xlsx
mv *Descriptores_.xlsx Descriptores.xlsx
